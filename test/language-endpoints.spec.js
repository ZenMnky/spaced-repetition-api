...
describe('Language Endpoints', () => {
  ...
  describe('Endpoints protected by user', () => {
    ...
    languageSpecificEndpoint.forEach((endpoint) => {
      describe(endpoint.title, () => {
        beforeEach('insert users, languages and words', () => helpers.seedUsersLanguagesWords(
          db,
          testUsers,
          testLanguages,
          testWords,
        ...
        it('responds with 404 if user doesn\'t have any languages', () => endpoint.method(endpoint.path)
  ...
  describe('GET /api/language', () => {
    ...
    it('responds with 200 and user\'s language and words', () => supertest(app)
      .get('/api/language')
  ...
  describe('GET /api/language/head', () => {
    ...
    it('responds with 200 and user\'s next word to learn, along with total score and correct/incorrect count', () => supertest(app)
  ...
  describe('POST /api/language/guess', () => {
    ...
    context('Given incorrect guess', () => {
      ...
      it('responds with incorrect and moves head', async () => await supertest(app)
        .post('/api/language/guess')
        .set('Authorization', helpers.makeAuthHeader(testUser))
